...
model.add(GRU(64, return_sequences=True, input_shape=(99,81)))
model.add(GRU(64))
...
model.fit(x_train, y_train, batch_size=128, validation_data=(x_valid, y_valid), epochs=10, shuffle=True, verbose=2)
